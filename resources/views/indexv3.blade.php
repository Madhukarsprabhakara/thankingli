...
<head>
  ...
  <link rel="stylesheet" href="unify/html/assets/vendor/hs-bg-video/hs-bg-video.css">
...
<body>
  ...
  <main>
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="/loginv3" >Log In</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <!-- Login -->
    <section class="dzsparallaxer auto-init g-bg-blue-lineargradient-v3 height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
            ...
            <div class="row">
              <div class="col-md-11 col-lg-9">
               ...
               <!--  <div class="media mb-5">
                  ...
                  <div class="media-body align-self-center">
                    <p class="g-color-white mb-0">Be the person you wish to see in others</p>
                  </div>
                </div> -->
                <!-- End Icon Blocks -->
              ...
              <form class="g-py-15" method="POST" action="{{ route('register') }}">
                ...
                <!-- <div class="row"> -->
                  <div class="mb-4">
                    <div class="input-group">
                      ...
                      <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover g-py-15 g-px-15" id="name" type="text" name="name" placeholder="Full Name" required>
                      @if ($errors->has('name'))
                ...
                <div class="mb-4">
                  <div class="input-group">
                    ...
                    <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover g-py-15 g-px-15" id="email" type="email" name="email" placeholder="Your Email">
                  </div>
                      @if ($errors->has('email'))
                        <div class="alert alert-danger" role="alert">
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-6 mb-4">
                    <div class="input-group">
                      ...
                      <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover g-py-15 g-px-15" id="password" type="password" name="password"  placeholder="Password">
                    </div>
                  ...
                  <div class="col-xs-12 col-sm-6 mb-4">
                    <div class="input-group">
                      ...
                      <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover g-py-15 g-px-15" type="password" id="password-confirm" name="password_confirmation" placeholder="Confirm password">
                    </div>
                ...
                <div class="mb-5">
                 <!--  <label class="form-check-inline u-check g-color-gray-dark-v5 g-font-size-13 g-pl-25 g-mb-20">
                  ...
                  <button class="btn btn-md btn-block u-btn-primary g-py-13 g-px-25"  type="submit">Sign Up</button>
                </div>
              </form>
              <!-- End Form -->

              <footer class="text-center">
                <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Already have an account? <a class="g-font-weight-600" href="/loginv3">Log In</a>
                </p>
              </footer>
            </div>
          </div>
...
<!-- End Footer -->
  ...
  <script src="unify/html/assets/vendor/hs-bg-video/hs-bg-video.js"></script>
  <script src="unify/html/assets/vendor/hs-bg-video/vendor/player.min.js"></script>
  ...
  <script src="unify/html/assets/js/helpers/hs.bg-video.js"></script>
