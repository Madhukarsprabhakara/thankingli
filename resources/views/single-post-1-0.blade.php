...
<li>
 ...
 -->
							...
							<figure class="mb-20">
								<img class="" height="600"  src="{{URL::asset('')}}{{$ThankedByUser->image}}" alt="img" />
							</figure>
							@endif
							<!-- /IMAGE -->
								...
								<form role="form" method="post" action="{{URL::asset('')}}comments/{{$ThankedByUser->post_thank_id}}/store">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<textarea name="commenttext" placeholder="" class="form-control" rows="5" required>{{old('commenttext')}}</textarea>
										</div>
									</div>
									...
									<div class="row">
										...
										@else
											<div class="alert alert-danger">
 											 <strong></strong> You MUST be logged in to comment.
											</div>
											<button class="btn btn-3d btn-md btn-reveal btn-blue" disabled>
												<i class="fa fa-check"></i>
												<span>Submit Comment</span>
											</button>
										@endif
