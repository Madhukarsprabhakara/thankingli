...
<li>
 <div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    ...
    <li><a class="pull-left" href="{{URL::asset('latestposts')}}" >Look who's thanking! <i class="fa fa-angle-right"></i></a></li>
...
<!--                     <a class="pull-right" href="{{URL::asset('thankwall')}}" >Latest thank stories <i class="fa fa-angle-right"></i></a> -->
                    <a class="pull-right" href="{{URL::asset('latestposts')}}" >Look who's thanking!<i class="fa fa-angle-right"></i></a>
