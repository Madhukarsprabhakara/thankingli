...
<html lang="en-US">
	<head>
		...
		<title>thankSumone - Business</title>
...
<!-- 								<i class="fa fa-menu-arrow pull-right"></i> -->
			...
			<header id="header">
				...
				<span class="logo pull-left">
					<img src="assets-admin/images/logo_light.pn" alt="thankSumone" height="35" />
				</span>
					...
					<div class="col-md-6 push-md-3 col-sm-6 	">
						<!-- INLINE SEARCH -->
							<div class="inline-search clearfix mb-30">
								<form method="get" id="search" action="/searchcode" class="widget_search">
		...
		<!-- 
<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.resize.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.time.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.fillbetween.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.orderBars.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.pie.min.js"></script>
		<script type="text/javascript" src="assets-admin/plugins/chart.flot/jquery.flot.tooltip.min.js"></script>
 -->
		<!-- PAGE LEVEL SCRIPT -->
...
<!-- 		<script async type="text/javascript" src="assets-admin/plugins/styleswitcher/styleswitcher.js"></script> -->
	</body>
</html>
