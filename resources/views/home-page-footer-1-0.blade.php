...
<!-- 				<img class="footer-logo" src="assets/images/_smarty/logo-footer.png" alt="" /> -->
				...
				<!-- Small Description -->
				<p>Thankingli helps people express gratitude for anyone, anything or anyplace.</p>
				...
				<address>
					<ul class="list-unstyled">
						...
						<li class="footer-sprite email">
							<a href="mailto:support@yourname.com">feedback@thankingli.com</a>
						</li>
					</ul>
				</address>
				<!-- /Contact Address -->
...
<!-- 				<div class="col-md-2"> -->
				...
				<ul class="footer-links list-unstyled">
					...
					<li><a href="/first-hundred">The First 100!</a></li>
...
<!-- 			</div> -->
			...
			@if (Auth::check())
				...
				<h4 class="letter-spacing-1">Help us make this world a better place</h4>
