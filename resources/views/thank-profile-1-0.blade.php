...
<!-- 
 ...
 -->
 				...
 				<div id="pre-cat0" class="col-md-6 push-md-3 col-sm-6  centered">
...
<!-- 											<label>Name of the person you wish to thank *</label> -->
											<input type="text" name="name" value="{{$userOnId->name}}" size="100" placeholder="Name of the person you wish to thank" readonly="readonly" class="form-control" required>
										</div>
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
<!-- 												<label>Email </label> -->
											<input type="hidden" name="email" size="100" value="{{$userOnId->email}}" placeholder="Email of the person you wish to thank" class="form-control" required>
										</div>
...
<!-- 											<label class="checkbox"> -->
													<input name="emailpresent" id="surprise" value="1" readonly="readonly" type="hidden">
 ...
 -->
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<!-- primary -->
											<!-- checkbox -->
											<h3>Want to buy {{$userOnId->name}} a Coffee? (Optional)</h3>
											<label class="checkbox">
