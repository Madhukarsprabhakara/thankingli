...
<!-- 						<a class="btn btn-blue pull-right" href="{{asset('thank-someone-1-0')}}">Thank someone!</a> -->
						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="side-nav mb-60 mt-30">
								...
								<ul class="list-group list-group-bordered list-group-noicon uppercase">
									...
									<li class="list-group-item active"><a href="/thankwall"><span class="fs-11 text-muted float-right"></span> People you thanked</a></li>
									<li class="list-group-item "><a href="/thankfeed"><span class="fs-11 text-muted float-right "></span> Thank feed</a></li>
									<li class="list-group-item "><a href="/private"><span class="fs-11 text-muted float-right "></span> Private Messages</a></li>
