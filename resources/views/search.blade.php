...
<!--         <hr> -->
    ...
    @foreach ($searchNames as $searchName)
    	...
    	<div class="row">
            <ul>
                <li class=""><a href="{{URL::asset('profile/id')}}/{{$searchName->id}}">{{ $searchName->name }}</a>
                </li>
                <!-- 
<li class=""><a href="#">{{ $searchName->email }}</a>
                </li>
 -->
            </ul>
        </div>
    ...
    @endforeach
        ...
        <div class="row">
            <ul class="pager">
                <li class="previous"><a href="{{$searchNames->previousPageUrl()}}">&larr; Previous</a>
                </li>
                <li class="next"><a href="{{$searchNames->nextPageUrl()}}">Next &rarr;</a>
                </li>
            </ul>
        </div>
