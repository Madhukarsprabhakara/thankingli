...
<head>
  <!-- Title -->
  <title>Profile Information | Unify - Responsive Website Template</title>
  ...
  <link rel="stylesheet" href="/unify/html/assets/vendor/hs-admin-icons/hs-admin-icons.css">
  ...
  <link rel="stylesheet" href="/unify/html/assets/vendor/bootstrap-select/css/bootstrap-select.min.css">
  <link rel="stylesheet" href="/unify/html/assets/vendor/flatpickr/dist/css/flatpickr.min.css">

  <link rel="stylesheet" href="/unify/html/assets/vendor/chartist-js/chartist.min.css">
  <link rel="stylesheet" href="/unify/html/assets/vendor/chartist-js-tooltip/chartist-plugin-tooltip.css">
  <link rel="stylesheet" href="/unify/html/assets/vendor/fancybox/jquery.fancybox.min.css">

  <!-- CSS Unify -->
  <link rel="stylesheet" href="/unify/html/assets/css/unify-admin.css">
...
<body>
    ...
    <header id="js-header" class="u-header u-header--sticky-top">
      <div class="u-header__section u-header__section--admin-dark g-min-height-65">
        <nav class="navbar no-gutters g-pa-0">
          ...
          <div class="col-auto d-flex g-py-12 g-pl-40--lg ml-auto">
                ...
                <ul class="p-0 mb-0">
                  ...
                  <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                    <div class="d-flex g-mr-15">
                      <img class="g-width-40 g-height-40 rounded-circle" src="/unify/html/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                    </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>5 Min ago</small>
                  ...
                  <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                    <div class="d-flex g-mr-15">
                      <img class="g-width-40 g-height-40 rounded-circle" src="/unify/html/assets/img-temp/100x100/img6.jpg" alt="Image Description">
                    </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>22 Min ago</small>
                  ...
                  <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                    <div class="d-flex g-mr-15">
                      <img class="g-width-40 g-height-40 rounded-circle" src="/unify/html/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                    </div>
        ...
        <span class="u-badge-v2--xs u-badge--top-right g-hidden-sm-up g-bg-lightblue-v5 g-mr-5"></span>
                  <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="/unify/html/assets/img-temp/130x130/img1.jpg" alt="Image description">
                  </span>
                ...
                <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
                  ...
                  <section class="text-center g-mb-30 g-mb-50--md">
                    <div class="d-inline-block g-pos-rel g-mb-20">
                      ...
                      <!-- <img class="img-fluid rounded-circle" src="/unify/html/assets/img-temp/130x130/img1.jpg" alt="Image description"> -->
                    </div>
                          ...
                          <div class="col-auto align-self-center g-width-270 g-px-10">
                            <div class="form-group u-select--v2 g-pos-rel g-brd-gray-light-v7 g-rounded-4 mb-0">
                              ...
                              <select name="language" class="js-select u-select--v2-select w-100" required="required" style="display: none;">
                                <option data-content='<span class="d-flex align-items-center"><img class="g-width-20 g-height-20 rounded-circle g-mr-8" src="/unify/html/assets/img/langs/us.png" alt="Image Description"><span class="g-line-height-1 g-color-black">English</span></span>'>English</option>
                                <option data-content='<span class="d-flex align-items-center"><img class="g-width-20 g-height-20 rounded-circle g-mr-8" src="/unify/html/assets/img/langs/de.png" alt="Image Description"><span class="g-line-height-1 g-color-black">Deutsche</span></span>'>Deutsche</option>
                                <option data-content='<span class="d-flex align-items-center"><img class="g-width-20 g-height-20 rounded-circle g-mr-8" src="/unify/html/assets/img/langs/ru.png" alt="Image Description"><span class="g-line-height-1 g-color-black">Русский</span></span>'>Русский</option>
                              </select>
                              <i class="hs-admin-angle-down g-absolute-centered--y g-right-0 g-color-gray-light-v6 ml-auto g-mr-15"></i>
                            </div>
                          </div>
  ...
  <script src="/unify/html/assets/vendor/cookiejs/jquery.cookie.js"></script>
  ...
  <script src="/unify/html/assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
  <script src="/unify/html/assets/vendor/flatpickr/dist/js/flatpickr.min.js"></script>
  <script src="/unify/html/assets/vendor/jquery-validation/dist/jquery.validate.min.js"></script>

  <script src="/unify/html/assets/vendor/chartist-js/chartist.min.js"></script>
  ...
  <script src="/unify/html/assets/js/components/hs.side-nav.js"></script>

  <script src="/unify/html/assets/js/components/hs.range-datepicker.js"></script>
  <script src="/unify/html/assets/js/components/hs.validation.js"></script>

  <script src="/unify/html/assets/js/components/hs.bar-chart.js"></script>
