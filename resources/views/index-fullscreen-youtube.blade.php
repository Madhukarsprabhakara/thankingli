...
<h2 class="fw-300 text-white wow fadeInUp" data-wow-delay="1s">Thank a mother</h2>
 ...
 -->
							<!--	<h2 class="fw-300 text-white wow fadeInUp">We are on a mission to make this world more lovable and more thankful.</h2>-->
								...
								<h2 class="fw-300 text-white wow fadeInUp">Thank someone with words, or even better, a "Thank You Coffee".</h2>
								<!-- 
<h1 class="text-white wow fadeInUp" data-wow-delay="3s">
 ...
 -->
								@if (Auth::check())
									<a class="btn btn-primary btn-lg wow fadeInUp" id="thanksomeonea"  data-wow-delay="1s" href="#thanksomeone">Thank someone!</a>
								@else
									 <a class="btn btn-primary btn-lg wow fadeInUp" data-wow-delay="1s" id="readstoriesa" href="#thankstories">Read Thank stories</a>
								@endif	
							</div>
...
<div class="col-md-3 col-sm-3">
 ...
 -->
 			...
 			<div class="container">
 			<div class="col-md-6 push-md-3 col-sm-6 text-center">
					<a href="javascript:;" id="indexinviteandthank" onclick="jQuery('#pre-cat0').slideToggle();">Invite and thank,If the person is not on the platform</a>
				</div>
 			<div class="row">
 				<!-- 
<div class="col-md-3 col-sm-3">
 ...
 -->
  ...
  // resubmits the form once the hit is done.
		...
		<script type="text/javascript">
			...
			jQuery('#thanksomeonea').click(function(){
			var match = jQuery(this).attr('href').match(/#\S+/);
			ga('send', 'pageview', location.pathname + match[0]);
			});
			jQuery('#readstoriesa').click(function(){
                        var match = jQuery(this).attr('href').match(/#\S+/);
                        ga('send', 'pageview', location.pathname + match[0]);
                        });
			jQuery('#indexinviteandthank').click(function(){ 
                        var match = jQuery(this).attr('href').match(/#\S+/);
                        ga('send', 'pageview', location.pathname + match[0]);
                        });
			jQuery('.blog-post-item a').click(function(){ 
                        var match = jQuery(this).attr('href').match(/#\S+/);
                        ga('send', 'pageview', location.pathname + match[0]);
                        });
