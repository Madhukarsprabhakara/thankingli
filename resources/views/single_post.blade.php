              ...
              <ul id="topMain" class="nav nav-pills nav-main">
                ...
                @if (Route::has('login'))
                  ...
                  <li class="dropdown">
                            ...
                            @else
                              <!-- <li>
                    <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pr-30 g-pl-30 g-pl-0--lg">
                      <a class="btn u-btn-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="/" >Sign Up</a>
                    </div> -->
...
<div id="app">
          ...
          <div class="g-pl-20--lg ">
            ...
            <article>
              ...
              <div class="g-brd-around g-brd-secondary-light-v2 g-bg-white g-pa-20">
                ...
                <a class="btn u-btn-primary" href="http://localhost/thanksomeonev3" >Thank someone!
</a>
              </div>
            ...
            <nav  class="text-center" aria-label="Page Navigation">
              ...
              <ul class="list-inline">
                ...
                <li class="list-inline-item">
                  <a class="u-pagination-v1__item u-pagination-v1-4 u-pagination-v1-4--active g-rounded-5 g-pa-7-14" href="http://localhost/feed">Home</a>
                </li>
    ...
    <!-- End Blog Minimal Blocks -->
               <template  id="thankdata"> 
                <div> 
                  <article >
              <img v-if="post['image']" class="img-fluid w-100" :src="'http://localhost/'+post['image']" :alt="post['image']">

              <div   class="g-brd-around g-brd-secondary-light-v2 g-bg-white g-pa-20">
                <p class="g-font-size-10">@{{post['from_name']}} <i class="align-middle mr-1 icon-medical-022 u-line-icon-pro"></i>@{{post['to_name']}}</p>
                <h3 class="g-font-size-16"><a class="u-link-v5 g-color-main g-color-primary--hover" href="#!"  >@{{post['thank_title']}}</a></h3>
                <p class="g-font-size-13">@{{post['thank_description']}}</p>
                ...
                <div v-if="commentShow" class="g-brd-around g-brd-secondary-light-v2 g-bg-lightblue g-pa-20" >
                  ...
                  <textarea  v-if="feed['loggedInFlag']" class="form-control form-control-md  rounded-2" v-model="commenttext" rows="2" placeholder="Add a comment or Respond to the Thank You message"></textarea>
                  <textarea  v-else class="form-control form-control-md  rounded-2" v-model="commenttext" rows="2" placeholder="You must be logged in to post comments" disabled></textarea>
                </div>

                  <div class="form-group g-mb-5">
                  <a href="#!" v-on:click.stop.prevent="postComment(post['post_thank_id'],feed['ThankedBy']['current_page'],feed['ThankedBy']['path'])" v-if="commenttext.length > 0 && feed['loggedInFlag']" class="btn btn-xs u-btn-primary g-mr-5 g-mb-5">Post</a>
                  <!-- <p v-else>You should be singned in to comment</p> -->
                </div>
...
//      console.log("Yes its here " +this.key);
    ...
    postComment:function(postid,index,path) {
        ...
        //alert(postid+' '+this.commenttext+' '+index);
        this.$http.post('http://localhost/comments/'+postid+'/'+'storev3',{
            ...
            {
                this.commenttext="";
                this.nextPage('http://localhost/'+vm.currentRoute+'/show');
...
//      console.log("Yes its here " +this.key);
    ...
    populateFeed:function() {
      this.loading = true;
        this.$http.get('http://localhost/'+this.currentRoute+'/show').then(function(response){
          if(response.status == "200")
          {
